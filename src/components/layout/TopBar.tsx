        ...
        <>
            <div className="flex flex-row justify-between shadow-sm rounded-sm items-center w-[100%] p-[1rem] py-[2rem]">
                <div className="flex flex-row justify-between items-center">
                    ...
                    <div className="flex flex-row items-center">
                        <label htmlFor="search">
                            <IoSearch  size={14} className="mr-2 self-center cursor-pointer text-[#a6a6a6]" />
                        </label>
                        <input 
                            type="search" 
                ...
                <div className="flex flex-row justify-between items-center">
                    ...
                    <div className="flex flex-row items-center mr-5 cursor-pointer">
                        <HiMiniComputerDesktop size={14} className="text-[#a6a6a6] mr-[0.25rem]" />
                        <h3>Tour</h3>
                    </div>
                    <div className="flex flex-row items-center mr-3 cursor-pointer">
                        <Image className="mr-[0.25rem] border border-solid border-[#a6a6a6] rounded-[50%]" src="/stackUser.png" width={24} height={24}  alt="user"/>
